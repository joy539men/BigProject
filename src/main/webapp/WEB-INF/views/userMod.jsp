		...
		<nav class="navbar navbar-expand-xl navbar-light text-center py-3">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<div>
						<!-- account btn -->
						<a href="#!" class="p-3 border rounded-pill "><i
	...
	<div class="container my-4">
		...
		<form:form method="post" modelAttribute="user" action="${ register}"
			...
			<div class="row mb-3">
				...
				<div class="col">
					<label for="confirmNewPassword" class="form-label" style="font-size: 18px;">確認新密碼</label>
					<form:input type="password" class="form-control" id="confirmPassword" path="confirmPassword" />
					<div id="passwordError" class="error" style="font-size: 14px; color: red;"></div>
				</div>
			</div>
			...
			<div class="row mb-3">
				...
				<div class="col">
					...
					<form:input type="identity" class="form-control" id="identity"
						path="identity" value="${user.identity}" />
				</div>
