...
<head>
	<meta charset="utf-8">
	<title>Personal Informationn</title>
  ...
  <form>
    ...
    <div class="row mb-3">
      ...
      <div class="col">
        ...
        <input type="email" class="form-control" id="email" placeholder="您的Email">
      </div>
    </div>
    ...
    <div class="row mb-3">
      ...
      <div class="col">
        ...
        <input type="text" class="form-control" id="idCard" placeholder="您的身分證號碼">
      </div>
    </div>
    ...
    <div class="row mb-3">
      <div class="col">
        ...
        <input type="tel" class="form-control" id="phone" placeholder="您的電話號碼">
      </div>
      <div class="col">
        <label for="address" class="form-label" style="font-size: 18px;">地址</label>
        <input type="text" class="form-control" id="address" placeholder="您的地址">
      </div>
    </div>

    <!-- Profile Picture -->
    <div class="mb-3">
      <label for="profilePicture" class="form-label" style="font-size: 18px;">更改大頭貼</label>
      <input type="file" class="form-control" id="profilePicture">
    </div>

    <div class="row">
		<div class="col text-center">
		  <button type="submit" class="btn btn-primary" style="font-size: 20px;">確認更改</button>
		</div>
	</div>
  </form>
</div>
