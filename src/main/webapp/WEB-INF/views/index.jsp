		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"> <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">頁面</a>
				...
				<!-- account btn --> <a href="#!" class="btn btn-outline-primary">登 入</a>
      ...
      <div class="modal-body">
        <form action="#!" method="post">
          <div class="row">
            ...
            <div class="col-lg-12">
              <button type="submit" class="btn btn-primary w-100">提 交 資 料</button>
            </div>
          </div>
        </form>
      </div>
    ...
    <div class="row align-items-center justify-content-center">
      <div class="col-lg-6 mb-5 mb-lg-0">
        <div class="block text-center text-lg-start pe-0 pe-xl-5">
          <h1 class="text-capitalize mb-4">人生</h1><br><h1>從我們離開舒適圈開始</h1><br><h3>沙發衝浪 帶你體驗人生</h3>
          <p class="mb-4">你品嚐了夜的巴黎 你踏過下雪的北京 你熟記書本裡 每一句你最愛的真理</p> <a type="button"
            class="btn btn-primary" href="#" data-bs-toggle="modal" data-bs-target="#applyLoan">提 供 資 料 <span style="font-size: 14px;" class="ms-2 fas fa-arrow-right"></span></a>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="ps-lg-5 text-center">
          <img loading="lazy" decoding="async"
            src="images/index_start.png"
...
<section>
	...
	<a href="<c:url value="/mainPage"></c:url>">房間地圖</a>
